  ...
  <table class="list compare-info">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/crystal/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
    ...
    <tr>
      <td></td>
      <?php foreach ($products as $product) { ?>
      <td><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button"><i class="icon-shopping-cart che"></i><?php echo $button_cart; ?></a></td>
      <?php } ?>
    </tr>
    <tr>
      <td></td>

<div class="box">
  <div class="box-heading bestsell"><span><?php echo $heading_title; ?></span></div>
  <div class="box-grid">
    <ul id="product_list">
        ...
        <div class="grid_image">
          ...
          <div class="discount_timer">
            ...
            <div class="count_holder_small">
              <div id="Bestseller<?php echo $product['product_id']; ?><?php echo $module; ?>"></div>
              <script type="text/javascript">
					$(function () {	
						$('#Bestseller<?php echo $product['product_id']; ?><?php echo $module; ?>').countdown({until: new Date(<?php echo $product['date_end']; ?>), compact: false});
					});
		</script> 
            </div>
            <?php } ?>

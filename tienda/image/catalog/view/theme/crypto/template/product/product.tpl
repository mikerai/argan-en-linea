  ...
  <div class="box">
    <div class="product-info">
      ...
      <div class="left" style="width: <?php echo $this->config->get('config_image_thumb_width') + 22 ?>px;">
        <?php if($this->config->get('productzoom_status') == '1'){ ?>
        <?php include dirname(__FILE__) . '/zoom.php'; ?>
        <?php } else { ?>
        <?php include dirname(__FILE__) . '/colorbox.php'; ?>
        <?php } ?>
      </div>
      <?php } ?>
      <div class="right" style="margin-left: <?php echo $this->config->get('config_image_thumb_width') + 52 ?>px;">
        ...
        <div class="review"> <img src="catalog/view/theme/crypto/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /><span class="show-review"><?php echo $reviews; ?></span> </div>
        <?php } ?>
        <?php if ( $date_end == '0000, 00 - 1, 00' ) { } else { ?>
        <div class="count_holder_small" style="float:left;">
          <div id="ProductPage"></div>
          <script type="text/javascript">
					$(function () {	
						$('#ProductPage').countdown({until: new Date(<?php echo $date_end; ?>), compact: false});
					});
		</script> 
        </div>
        <?php } ?>
        <div class="customprdblockfir">
          ...
          <div class="description">
            ...
            <span><?php echo $text_qty; ?></span> <script>
      ...
      <?php endif; ?>
          ...
          <div class="cart">
            <div> <i class="icon-shopping-cart prdadd" style="margin-top:11px;"></i>
              <input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="icon-cart-white button highlight" />
            </div>
            <div> <a onclick="addToWishList('<?php echo $product_id; ?>');"><i class="icon-heart prdwi"></i><?php echo $button_wishlist; ?></a> <a onclick="addToCompare('<?php echo $product_id; ?>');"><i class="icon-bar-chart prdwi"></i><?php echo $button_compare; ?></a> </div>
            <div>
        ...
        <?php if($this->config->get('customproductcolumn_status') == "1") {  ?>
        <?php if ($this->config->get('producttexttitleshow') == "1") { ?>
        <div class="customprdblock">
          <h2> <?php echo $this->config->get('producttexttitle'); ?></h2>
          <p><?php echo $this->config->get('producttextdescription'); ?></p>
        </div>
        <?php } ?>
        <?php if ($this->config->get('producttexttitle2show') == "1") { ?>
        <div class="customprdblock">
          <h2> <?php echo $this->config->get('producttexttitle2'); ?></h2>
          <p><?php echo $this->config->get('producttextdescription2'); ?></p>
        </div>
        <?php } ?>
        <?php if ($this->config->get('producttexttitle3show') == "1") { ?>
        <div class="customprdblock">
          <h2> <?php echo $this->config->get('producttexttitle3'); ?></h2>
          <p><?php echo $this->config->get('producttextdescription3'); ?></p>
        </div>
        <?php } ?>
        <?php } ?>
      </div>
    ...
    <div id="tab-review" class="tab-content">
      ...
      <div class="buttons">
        <div class="right"><a id="button-review" class="button"><i class="icon-share-alt che"></i><?php echo $button_continue; ?></a></div>
      </div>
    </div>
    <?php } ?>
    <?php if ($products) { ?>
           ...
           ?>
            ...
            <div class="discount_timer">
              ...
              <div class="count_holder_small">
                <div id="ProductPage<?php echo $product['product_id']; ?><?php echo $module; ?>"></div>
                <script type="text/javascript">
					$(function () {	
						$('#ProductPage<?php echo $product['product_id']; ?><?php echo $module; ?>').countdown({until: new Date(<?php echo $product['date_end']; ?>), compact: false});
					});
		</script> 
              </div>
              <?php } ?>

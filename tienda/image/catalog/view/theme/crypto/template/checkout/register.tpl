    ...
    <div style="clear: both; padding-top: 3px; border-top: 1px solid #eee;">
      <p><input type="checkbox" name="newsletter" value="1" id="newsletter" />&nbsp;&nbsp;<label for="newsletter"><?php echo $entry_newsletter; ?></label></p>
      <?php if ($shipping_required) { ?>
      <p><input type="checkbox" name="shipping_address" value="1" id="shipping" checked="checked" />&nbsp;&nbsp;<label for="shipping"><?php echo $entry_shipping; ?></label></p>
      <?php } ?>
    </div>
    <?php if ($text_agree) { ?>
    <div class="buttons clearafter">
      <div class="right">
        <i class="icon-share-alt prdadd" style="margin-top:21px;"></i> <input type="button" value="<?php echo $button_continue; ?>" id="button-register" class="icon-forward-white button" />
      </div>
      <p>

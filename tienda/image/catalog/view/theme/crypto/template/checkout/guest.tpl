    ...
    <div class="buttons">
      <div class="right">
       <i class="icon-share-alt prdadd" style="margin-top:21px;"></i>  <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" class="icon-forward-white button" />
      </div>
    </div>
